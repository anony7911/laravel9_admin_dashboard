        ...
        <div id="main">
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32" fill="blue" style="width:10px">
                                                        <use xlink:href="{{ url('/') }}/assets/images/bootstrap-icons.svg#circle-fill" />
                                                    </svg>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div       class                     = "float-end">
                    <p>Crafted with Alhilal  <span class = "text-danger"><i class = "bi bi-heart"></i></span> by <a href = "https://saugi.me">Saugi</a></p>
                    </div>
                </div>
            </footer>
        </div>
